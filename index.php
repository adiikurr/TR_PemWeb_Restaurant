...
<header class="header">
   ...
   <section class="flex">
      ...
      <a href="#home" class="logo"><span>Pizza</span>Masbroo</a>
...
<section class="order" id="order">
   ...
   <?php
      ...
      <div class="grand-total"> Total Harga : <span>Rp <?= $grand_total; ?>,-</span></div>
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            ...
            <input type="number" name="number" class="box" required placeholder="Masukan nomor whatsapp" min="0" max="9999999999" onkeypress="if(this.value.length == 10) return false;">
         </div>
         <div class="inputBox">
         ...
         <div class="inputBox">
            <span>Nama Jalan/Gedung/Tempat:</span>
            <input type="text" name="flat" class="box" required placeholder="Contoh : Jl. Diponegoro no. 5" maxlength="50">
         </div>
         <div class="inputBox">
         ...
         <div class="inputBox">
            <span>Kode Pos :</span>
            <input type="number" name="pin_code" class="box" required placeholder="Contoh : 15560" min="0" max="99999" onkeypress="if(this.value.length == 6) return false;">
         </div>
      </div>
...
<section class="about" id="about">
   ...
   <div class="box-container">
      ...
      <div class="box">
         <img src="images/meme/meme1.gif" alt="">
         <h3>Rio Arya Andika</h3>
         <p>NIM : 672021166</p>
      </div>

      <div class="box">
         <img src="images/meme/meme2.gif" alt="">
         <h3>M. Randy Dani Prabawa</h3>
         <p>NIM : 672021168</p>
      </div>

      <div class="box">
         <img src="images/meme/meme3.gif" alt="">
         <h3>Adi Kurniawan</h3>
         <p>NIM : 672021172</p>
...
<section class="footer">
   ...
   <div class="credit">
      &copy; Copyright @ <?= date('Y'); ?> by <span>Masbro Team</span> | All Rights Reserved
   </div>
